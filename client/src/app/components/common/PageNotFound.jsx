...
export const PageNotFound = () => {
    ...
    return (
        <div className="w-[inherit] h-full flex flex-wrap justify-center items-center mt-[100px] pb-[10%]">
            ...
            <Button
                buttonClass="w-full bg-gray-700 text-2xl text-yellow-200 font-[inherit] rounded py-[10px] px-[20px] cursor-pointer hover:text-yellow-400 active:text-yellow-500"
