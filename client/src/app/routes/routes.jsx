...
import { ProductCardsPage, ProductPage, CollectionPage, GlassTypePage, FrameTypePage, LenseTypePage } from "../components/pages";
import { PageNotFound } from "../components/common/PageNotFound.jsx";
import paths from "./paths.js";

const { BASE, REST, PRODUCTS, PRODUCT: { COLLECTION, GLASS_TYPE, FRAME_TYPE, LENSE_TYPE, ID }, AUTH, LOGIN, REGISTER, AUTH_LOGIN } = paths;
